...
def lambda_handler(event, context):
    try:
        ...
        base_url = "https://<s3 bucket where UI is hosted>.s3.amazonaws.com/"
        results = []
        for image in image_names_labels.keys():
            image_info_json = {"url": base_url + image, "labels": image_names_labels[image]}
